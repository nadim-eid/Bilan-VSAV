      ...
      return (
        <>
          ...
          <Accordion title="M — Médicaments / traitements" count={(form.SAMPLER.sampler_m_choices || []).length}>
            <SamplerField hideHeader value={form.SAMPLER.sampler_m} onChange={(v) => updateField('SAMPLER', 'sampler_m', v)} choiceOptions={MEDICAMENT_OPTIONS} choiceValue={form.SAMPLER.sampler_m_choices} onChoiceChange={(v) => updateField('SAMPLER', 'sampler_m_choices', withExclusiveNone(form.SAMPLER.sampler_m_choices || [], v, 'aucun'))} choiceMulti />
            <div className="border-t border-neutral-800 pt-3 flex flex-col gap-2">
          ...
          <Accordion title="P — Passé médical" count={(form.SAMPLER.sampler_p_choices || []).length}>
            <SamplerField hideHeader value={form.SAMPLER.sampler_p} onChange={(v) => updateField('SAMPLER', 'sampler_p', v)} choiceOptions={ANTECEDENTS_OPTIONS} choiceValue={form.SAMPLER.sampler_p_choices} onChoiceChange={(v) => updateField('SAMPLER', 'sampler_p_choices', v)} choiceMulti />
          </Accordion>
          ...
          <Accordion title="R — Facteurs de risque" count={(form.SAMPLER.sampler_r_choices || []).length}>
            <SamplerField hideHeader value={form.SAMPLER.sampler_r} onChange={(v) => updateField('SAMPLER', 'sampler_r', v)} choiceOptions={RISQUE_OPTIONS} choiceValue={form.SAMPLER.sampler_r_choices} onChoiceChange={(v) => updateField('SAMPLER', 'sampler_r_choices', v)} choiceMulti />
