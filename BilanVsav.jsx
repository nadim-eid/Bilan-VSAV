...
const EVENEMENT_OPTIONS = [
  ...
  { value: 'medicament', label: 'Prise de médicament' },
  { value: 'exposition_produit', label: 'Exposition à un produit' },
  { value: 'evenement_stressant', label: 'Événement stressant' },
];
...
const PAGE_FIELDS = {
  ...
  D: ['pci', 'pci_heure', 'pc_repete', 'pc_nombre', 'etat', 'orientation', 'neuro_signes', 'neuro_signes_depuis_choice', 'neuro_signes_depuis_heure', 'pupilles', 'sens_mains', 'sens_pieds', 'glycemie'],
    ...
    if (s === 'D')
      return (
        <>
          ...
          {form.D.pci === 'oui' && (
            <>
              <FieldCard label="Heure de la PCI" filled={!!form.D.pci_heure}>
                <InputBox
                  value={form.D.pci_heure}
                  onChange={(v) => updateField('D', 'pci_heure', formatTimeInput(v))}
                  placeholder="hh:mm"
                  width="w-28"
                  numeric
                />
